    ...
    },
    {
      ...
      content: (
        <>
          ...
          <h5><span style={{ color: "green" }}>綠色 ➜ "正確"</span>；
          <span style={{ color: "red" }}>紅色 ➜ "錯誤"</span></h5>
        </>
      )
    }
  ];
    ...
    <div className={styles.gameContainer} id="gameContainer">
      ...
      { showBackStory && (
        <div className={styles.backStory}>
          <p className={styles.backtitle}><b>【情境 - {currentConversation + 1}】</b></p>
          <p className={styles.backcontent}><b>{allScripts[fraudType][currentConversation].background}</b></p>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.records} id="records" style={{ visibility: showRecords ? 'visible' : 'hidden' }}>
          <div className={styles.recordsHeader}>
            ...
            <p style={{fontSize: '18px'}}><b>寶貝</b></p>
              <p>🟢上線中</p>
            </div>
